...
/* harmony import */ var _modules_ckeckTextInputs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/ckeckTextInputs */ "./src/js/modules/ckeckTextInputs.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_ckeckTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"]');
  Object(_modules_ckeckTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]');
  ...
  btns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      if (this.classList.contains('active-style')) {
        this.nextElementSibling.style.maxHeight = this.nextElementSibling.scrollHeight + 130 + "px";
      } else {
...
/***/ "./src/js/modules/ckeckTextInputs.js":
/*!*******************************************!*\
  !*** ./src/js/modules/ckeckTextInputs.js ***!
  \*******************************************/
/*! exports provided: default */
  ...
  var typeFilter = function typeFilter(markType) {
    ...
    if (markType) {
      markType.forEach(function (mark) {
        ...
        mark.classList.remove('animated', 'fadeOut');
      });
    } else {
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  var button = document.querySelector(trigger); // cards.forEach(card => {
